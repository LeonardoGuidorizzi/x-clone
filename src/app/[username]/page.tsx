  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
        ...
        <h1 className="font-bold text-lg">Leonardo Moreira</h1>
      </div>
      {/* INFO */}
      <div className="">
        ...
        <div className="p-4 flex flex-col gap-2">
          {/* USERNAME & HANDLE */}
          <div className="">
            <h1 className="text-2xl font-bold">LeonardoMoreira</h1>
            <span className="text-textGray text-sm">@guid0rizzi</span>
          </div>
          <p>Otari0 Youtube Channel</p>
          {/* JOB & LOCATION & DATE */}
